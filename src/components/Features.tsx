...
const Features = () => {
  ...
  return (
    <section className="section-padding bg-secondary/30 relative overflow-hidden">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="heading-2 mb-4 text-gradient animate-pulse-soft">
            Everything You Need to <span className="text-shimmer">Succeed</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="relative glass-card p-8 hover:shadow-lg transition-all duration-300 group animate-fade-in stagger-item"
            >
              <div className="mb-5 relative">
                ...
                <div className="relative float">{feature.icon}</div>
              </div>
        ...
        <div className="mt-16 glass-card p-8 relative overflow-hidden">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <h3 className="heading-3 text-gradient">Learn From <span className="text-shimmer">Anil Gupta</span></h3>
              ...
              <ul className="space-y-3">
                <li className="flex items-center text-foreground/80">
                  <Award className="mr-3 h-5 w-5 flex-shrink-0 text-primary" />
                ...
                <li className="flex items-center text-foreground/80">
                  <MessageSquare className="mr-3 h-5 w-5 flex-shrink-0 text-primary" />
      ...
      {/* Decorative elements */}
      <div className="absolute top-0 right-0 w-80 h-80 bg-primary/5 rounded-full filter blur-3xl transform translate-x-1/2 -translate-y-1/3"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-primary/5 rounded-full filter blur-3xl transform -translate-x-1/2 translate-y-1/3"></div>
    </section>
  );
};
