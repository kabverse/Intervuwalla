  ...
  return (
    <section className="relative pt-24 pb-20 md:pt-32 md:pb-32 overflow-hidden hero-gradient">
      <div className="container-tight relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            <div className="inline-flex items-center rounded-full bg-[hsl(var(--yellow))]/10 px-3 py-1 text-sm font-medium text-[hsl(var(--yellow))] animate-pulse">
              <span className="font-medium">New Workshop</span>
              <span className="ml-1 text-[hsl(var(--yellow))]/60">Starting This Week</span>
            </div>
            
            <h1 className="heading-1 text-gradient-blue-yellow animate-pulse-soft">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Button 
                size="lg" 
                className="rounded-full bg-primary hover:bg-primary/90 text-white font-medium btn-hover-expand btn-glow animate-pulse-soft"
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 z-20">
                <div className="text-white">
                  ...
                  <div className="mt-2 flex items-center">
                    <span className="text-[hsl(var(--yellow))] font-semibold">₹199</span>
      ...
      {isVideoModalOpen && (
        ...
        >
          <div 
            className="relative w-full max-w-4xl bg-primary/10 backdrop-blur-md rounded-2xl overflow-hidden shadow-2xl animate-scale-in"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="aspect-video bg-gray-900/50 flex items-center justify-center">
              <div className="text-center p-8">
                <h3 className="text-xl font-semibold text-gradient-blue-yellow mb-4">Meet Anil Gupta</h3>
