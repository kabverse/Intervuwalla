    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24">
        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#2e5ddd]/5 via-transparent to-[#D97706]/5 dark:from-blue-400/10 dark:to-[#daa520]/10"></div>
          ...
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#D97706]/10 dark:bg-[#daa520]/10 rounded-full filter blur-3xl animate-pulse-soft"></div>
          ...
          <div className="container relative z-10">
            <div className="text-center max-w-5xl mx-auto">
              ...
              <div className="inline-flex items-center mb-8 px-6 py-3 rounded-full glass-card border border-[#2e5ddd]/20 dark:border-blue-400/20 animate-fade-in">
                <Sparkles className="h-5 w-5 text-[#D97706] dark:text-[#daa520] mr-2 animate-pulse" />
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 animate-fade-in leading-tight">
                ...
                <span className="text-[#D97706] dark:text-[#daa520] relative">
                  Purpose
                  <div className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-[#2e5ddd] to-[#D97706] dark:from-blue-400 dark:to-[#daa520] rounded-full animate-pulse"></div>
                </span>
              </h1>
              ...
              <p className="text-xl md:text-2xl text-foreground/80 mb-12 max-w-3xl mx-auto leading-relaxed animate-slide-in-bottom">
                ...
                <span className="font-semibold text-[#D97706] dark:text-[#daa520]"> transformative education</span> and 
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                {[
                  ...
                  <div key={index} className="glass-card p-6 group hover:scale-105 transition-all duration-300 cursor-pointer">
                    ...
                    <div className="text-2xl md:text-3xl font-bold text-[#D97706] dark:text-[#daa520] mb-1">{stat.number}</div>
              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="glass-card p-10 group hover:shadow-2xl transition-all duration-500 relative overflow-hidden">
                  ...
                  <p className="text-lg text-foreground/90 leading-relaxed relative z-10">
                    ...
                    <span className="font-semibold text-[#D97706] dark:text-[#daa520]"> inspiring and transformative leaders</span>.
                  </p>
                </div>
                
                {/* Purpose Card */}
                <div className="glass-card p-10 group hover:shadow-2xl transition-all duration-500 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#D97706]/5 dark:bg-[#daa520]/5 rounded-full filter blur-xl group-hover:scale-150 transition-transform duration-700"></div>
                  
                  <div className="flex items-center mb-8 relative z-10">
                    <div className="p-4 rounded-xl bg-[#D97706]/10 dark:bg-[#daa520]/10 group-hover:bg-[#D97706]/20 dark:group-hover:bg-[#daa520]/20 transition-colors duration-300 mr-4">
                      <Heart className="h-10 w-10 text-[#D97706] dark:text-[#daa520]" />
                    </div>
                    <h2 className="text-3xl font-bold text-[#D97706] dark:text-[#daa520] group-hover:scale-105 transition-transform duration-300">Purpose</h2>
                  </div>
                  ...
                  <div className="space-y-4 relative z-10">
                    <p className="text-lg text-foreground/90 leading-relaxed">
                      ...
                      <span className="font-semibold text-[#D97706] dark:text-[#daa520]"> experiential learning</span>, and industry-aligned mentorship.
                    </p>
                    <div className="p-4 rounded-lg bg-gradient-to-r from-[#D97706]/10 to-[#2e5ddd]/10 dark:from-[#daa520]/10 dark:to-blue-400/10 border-l-4 border-[#D97706] dark:border-[#daa520]">
                      <p className="font-medium text-[#D97706] dark:text-[#daa520] text-lg">
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                  ...
                  <br />
                  <span className="text-[#D97706] dark:text-[#daa520]">Education to Employability</span>
                </h1>
                
                <p className="text-xl text-foreground/80 max-w-3xl mx-auto">
                  A Journey Rooted in Purpose — <span className="font-semibold text-[#D97706] dark:text-[#daa520]">Empowering 8,000+ Futures</span>
                </p>
              </div>
              ...
              <div className="space-y-8">
                <div className="glass-card p-8 hover:shadow-lg transition-all duration-300">
                  <p className="text-lg leading-relaxed text-foreground/90">
                    Anil Gupta has trained, coached, and mentored more than <strong className="text-[#D97706] dark:text-[#daa520]">8,000 students and professionals</strong> across 
                ...
                <div className="text-center p-12 glass-card bg-gradient-to-r from-[#D97706]/10 via-[#2e5ddd]/5 to-[#D97706]/10 dark:from-[#daa520]/10 dark:via-blue-400/5 dark:to-[#daa520]/10 relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    <div className="inline-block p-6 rounded-full bg-gradient-to-br from-[#D97706] to-[#2e5ddd] dark:from-[#daa520] dark:to-blue-400 mb-6 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <p className="text-2xl md:text-3xl font-bold text-[#2e5ddd] dark:text-blue-400 mb-4 leading-tight">
                      ...
                      <span className="text-[#D97706] dark:text-[#daa520]"> what about the rest of the country's aspiring talent?</span>"
                    </p>
        ...
        <section className="py-20 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-[#2e5ddd]/10 via-transparent to-[#D97706]/10 dark:from-blue-400/10 dark:to-[#daa520]/10"></div>
          
          <div className="container max-w-4xl relative z-10">
            <div className="text-center px-4 glass-card p-12 hover:shadow-2xl transition-all duration-500 group">
              <div className="mb-8">
                <div className="inline-flex items-center mb-4 px-4 py-2 rounded-full bg-gradient-to-r from-[#2e5ddd]/10 to-[#D97706]/10 dark:from-blue-400/10 dark:to-[#daa520]/10">
                  <Sparkles className="h-5 w-5 text-[#D97706] dark:text-[#daa520] mr-2" />
                ...
                <h2 className="text-4xl md:text-5xl font-bold mb-6 group-hover:scale-105 transition-transform duration-300">
                  ...
                  <br />
                  <span className="text-[#D97706] dark:text-[#daa520]">Your Career Journey?</span>
                </h2>
              </div>
              ...
              <p className="text-xl text-foreground/80 mb-10 max-w-2xl mx-auto leading-relaxed">
                ...
                <span className="font-semibold text-[#D97706] dark:text-[#daa520]"> expert mentorship</span>.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="rounded-full border-2 border-[#D97706] dark:border-[#daa520] text-[#D97706] dark:text-[#daa520] hover:bg-[#D97706]/10 dark:hover:bg-[#daa520]/10 px-8 py-4 text-lg font-medium"
                >
